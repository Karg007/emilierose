...
export default function PhotoPage() {
  const images = useMemo(() => Array.from({ length: 15 }, (_, i) => `/images/photo/${String(i+1).padStart(2,"0")}.jpg`), []);
    ...
    <main className="page">
      <section className="left">
        ...
        <div className="textBlock">
          <p>ENCHANTÉE! MOI, C’EST ÉMILIE ROSE, PHOTOGRAPHE LIFESTYLE POUR LES AMOUREUX DES SOUVENIRS CANDIDES, UNIQUES ET CHALEUREUX.</p>
          <p>JE VOUS SOUHAITE LA BIENVENUE ICI, DANS MON PETIT COIN CRÉATIF DU WEB. L’INTÉGRALITÉ DU SITE EST EN ROUTE MAIS EN ATTENDANT, ÉCRIVEZ-MOI AU <span className="highlight">INFO@EMILIEROSE.CA</span> POUR RÉSERVER VOTRE MOMENT PHOTO.</p>
          <p>MERCI À L’AVANCE DE ME CONFIER VOS PLUS BEAUX MOMENTS. J’AI TRÈS HÂTE DE FAIRE VOTRE RENCONTRE.</p>
